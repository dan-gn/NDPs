        ...
        new_line.update(
            {
                ...
                "best_graph_used_nodes": training_graph.get_number_of_used_nodes(
                    task.parameters["graph_n_inputs"],
                    task.parameters["graph_n_outputs"],
                ) if training_graph is not None else None,
                "best_graph_n_edges": training_graph.number_of_edges() if training_graph is not None else None,
                "best_graph_used_edges": training_graph.get_number_of_used_edges(
                    task.parameters["graph_n_inputs"],
                    task.parameters["graph_n_outputs"],
                ) if training_graph is not None else None,
        ...
        new_line.update(
            {
                ...
                "best_graph_n_nodes": training_graph.number_of_nodes() if training_graph is not None else None,
                "best_graph_used_nodes": best_individual.best_graph_used_nodes if training_graph is not None else None,
                "best_graph_n_edges": training_graph.number_of_edges() if training_graph is not None else None,
                "best_graph_used_edges": best_individual.best_graph_used_edges if training_graph is not None else None,
                **graph_reachability_fields(training_graph, task),
